<template>
	<div class="login-view"  >
			<el-form :model="loginForm"  status-icon :rules="rules" ref="loginForm"
               label-width="120px" class="web-ruleForm" @keyup.enter.native="submitForm('loginForm')">
				<div class="login-brand">速聊</div>
        <!-- <div style="text-align: center;">
          <a class="login-link" title="默认登录" @click="oauth2LoginHandler('GITEE')">
            <i class="operate-icon icon-gitee" />
            <p style="line-height: 20px;">默认登录</p>
          </a>
          <a class="login-link" title="手机号注册" @click="oauth2LoginHandler('phone')">
            <i class="operate-icon icon-github" />
            <p style="line-height: 20px;">手机号注册</p>
          </a>
        </div> -->
        <el-form-item label="用户名" prop="userName">
					<el-input type="userName" v-model="loginForm.userName" placeholder="登录账号名称" autocomplete="off"></el-input>
				</el-form-item>
        ...
        <el-form-item>
          ...
          <el-button @click="submitForm('loginForm')">清空</el-button>
				</el-form-item>
...
<style scoped lang="scss">
	.login-view {
		...
		width: 100%;
		height: 100%;
    background-image: url(~@/assets/images/WechatIMG252.jpeg);
