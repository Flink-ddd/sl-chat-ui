<template>
	<el-container>
		<el-aside width="280px" class="l-friend-box">
			<div class="l-friend-header">
				<div class="l-friend-search">
					<el-input width="260px" placeholder="搜索好友" v-model="searchText">
				...
				<!-- <el-button plain icon="el-icon-plus" style="border: none; padding:12px; font-size: 20px;color: rgb(117, 113, 113);" title="好友申请"
				 @click="handleShowAddFriendApply()"></el-button>
				<friend-apply :dialogVisible="showAddFriendApply" @close="handleCloseAddFriendApply">
				</friend-apply> -->
			</div>
	...
	export default {
		...
		data() {
			return {
				searchText: "",
				showAddFriend: false,
				showAddFriendApply: false,
				userInfo: {}
			}
		},
		methods: {
			handleShowAddFriendApply() {
				this.showAddFriendApply = true;
			},
			handleCloseAddFriendApply() {
				this.showAddFriendApply = false;
			},
			handleShowAddFriend() {
